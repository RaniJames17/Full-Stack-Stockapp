        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-3xl font-bold text-gray-900">
              {isAdmin ? "Admin Dashboard" : "Welcome to Your Dashboard"}
            </h1>
            <RoleBadge />
          </div>
    ...
    <>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <Link href="/admin/simple-users" className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left block">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Manage users, roles, and delete accounts</p>
              </div>
            </div>
          </Link>

          <Link href="/admin/audit-logs" className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left block">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Track administrative actions</p>
              </div>
            </div>
          </Link>

          <Link href="/admin/analytics" className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left block">
            <div className="flex items-center">
        ...
        <div className="space-y-4">
          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500">user@example.com joined the platform</p>
            </div>
          ...
          <div className="flex items-center p-3 bg-gray-50 rounded-lg">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-500">User promoted to moderator</p>
            </div>
    ...
    <>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left">
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Add new stock to portfolio</p>
              </div>
            </div>
          </button>
          ...
          <Link href="/demo/conditional-rendering" className="p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors text-left block">
            <div className="flex items-center">
              <div className="w-10 h-10 bg-purple-100 rounded-lg flex items-center justify-center mr-3">
                <svg className="w-5 h-5 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div>
                <p className="font-medium text-gray-900">Role Demo</p>
                <p className="text-sm text-gray-500">See conditional rendering</p>
              </div>
            </div>
          </Link>
        </div>
